...
public class Style {
    ...
    public void reset() {
        String items[] = {
            "area", "button", "button.red", "button.home", "button.green",
            "button.load", "button.load:selected", "description", "greenHover",
            "input", "label", "redHover", "select.item", "select.selected",
            "table", "table.td", "table.th", "window"
        };
