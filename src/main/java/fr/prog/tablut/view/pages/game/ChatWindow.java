...
public class ChatWindow extends JPanel {
    ...
    public ChatWindow() {
        ...
        for(int i = 0 ; i <= 100 ; i++) {
            addTextArea((i % 2 == 0 ? "L'attaquant " : "Le d\u00e9fenseur ") + i + " ", i % 2 == 0 ? new Color(193, 69, 69) : new Color(87, 158, 189), "a boug\u00e9 le pion en E5 vers A1");
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        int newHeight = getParent().getSize().height - 26;
